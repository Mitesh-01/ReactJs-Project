    ...
    return (
        <aside id="layout-menu" className="layout-menu menu-vertical menu bg-menu-theme">
            ...
            <ul className="menu-inner py-1">
                ...
                <li className="menu-item">
                    <Link to="/admin-slider" className="menu-link border shadow-sm">
                        <i className="bx bxs-carousel" /> Slider
                    </Link>
                </li>
                <li className="menu-item">
                ...
                <li className="menu-item">
                    <Link to="/admin-pincode" className="menu-link border shadow-sm">
                        <i className="bx bxs-map-pin" /> Pincode
                    </Link>
                </li>
                <li className="menu-item">
                    <Link to="/admin-shipping" className="menu-link border shadow-sm">
                        <i className="bx bxs-truck" /> Shipping
                    </Link>
                </li>
                <li className="menu-item">
